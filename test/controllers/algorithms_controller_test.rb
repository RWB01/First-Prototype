...
class AlgorithmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create algorithm" do
    assert_difference('Algorithm.count') do
      post algorithms_url, params: { algorithm: { description: @algorithm.description, theme_id: @algorithm.theme_id, title: @algorithm.title } }
    end
  ...
  test "should update algorithm" do
    patch algorithm_url(@algorithm), params: { algorithm: { description: @algorithm.description, theme_id: @algorithm.theme_id, title: @algorithm.title } }
